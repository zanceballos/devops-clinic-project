		...
		<div class="Home-section shadow">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-7">
						<img src="${pageContext.request.contextPath}/assetsimg/patient-home.svg" class="img-fluid" alt="" />
					</div>
				</div>
			</div>
		</div>
				...
				<div>
					<div class="row">
						<div class="col-lg-6">
							<div class="card shadow border-0 mb-3">
								<div class="card-header card-home bg-home border-0 py-4">
									<img class="card-img-top" src="${pageContext.request.contextPath}/assetsimg/select-clinic.svg"
										alt="" />
								</div>
								<div class="card-body">
									<h5 class="card-title">
						...
						<div class="col-lg-6">
							...
							<div class="card shadow border-0 mb-3">
								<div class="card-header card-home bg-home border-0 py-4">
									<img class="card-img-top" src="${pageContext.request.contextPath}/assetsimg/select-date.svg"
										alt="" />
								</div>
								<div class="card-body">
									<h5 class="card-title">
