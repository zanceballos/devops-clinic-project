			...
			<div class='row'>
				<div class='col-lg-6'>
					<div class="header text-white mt-4">
						...
						<p class="text-white">
							<b>Make changes to your Clinic Appointment Booking</b>
						</p>
					</div>
				...
				<div class='col-lg-6 text-center'>
					<img src="${pageContext.request.contextPath}/assetsimg/change.svg"
						...
						<div class="form px-3">
							...
							<c:if test="${update_datetime_error == true}">
								<div class="alert alert-danger py-3" role="alert">
									<i class="fas fa-exclamation-circle pr-2"></i><span>Date or Time Cannot be empty when updating the fields!!</span>
								</div>
